              ...
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <div className="grid grid-cols-4 gap-4">
                  ...
                  <TransactionInfo
                    ...
                    value={transaction?.payment_account_type}
                  />
                  <TransactionInfo
                    title="Customer Name"
                  ...
                  />
                  <TransactionInfo
                    title="Amount Without Charges"
                    value={transaction?.actualAmount}
                  />
                  <TransactionInfo
                  ...
                  <TransactionInfo
                    ...
                    value={transaction?.recipientNumber}
                  />
                  <TransactionInfo
                    title="Recipient Issuer"
                    value={transaction?.recipientIssuer}
                  />
                  <TransactionInfo
                  ...
                  <TransactionInfo
                    ...
                    value={transaction?.paymentIssuer}
                  />
                  <TransactionInfo
                    title="Reason"
                    value={transaction?.getReason() || null}
                  />
                </div>
              </div>
                          ...
                          if (result?.isConfirmed) {
                            confirmAlert({
                              ...
                              if (response.isConfirmed) {
                                const res =
                                  await transactionServices.changeTransStatus({
                                    id: transaction?._id,
                                    status: "paid",
                                  });
