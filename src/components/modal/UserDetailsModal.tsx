            ...
            <div className="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:min-w-sm w-2/3">
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <div className="grid grid-cols-4 gap-4">
                  ...
                  <UserInfo title="Phone Verfied" value={user?.phone_verified?'Verified':'Not Verfified'}/>
                  <UserInfo title="Account Status" value={user?.account_active?'Active':'Not Active'}/>
                  <UserInfo title="Blocked Status" value={user?.blocked?'Blocked':'Not Blocked'}/>
                  <UserInfo title="Last Updated" value={formatDate(user?.updatedAt)}/>
