                ...
                <tbody className="text-sm text-gray-600">
                    ...
                    <tr>
                        ...
                        <td className="border border-slate-300 text-left py-4">
                            ...
                            <div className="form-check">
                                    <Checkbox id="3" value="manage-admins/all" name="All Administrators" click={accessClick} isChecked={Array.isArray(checkedList)&&checkedList.some((id)=>(id==='3r')||(id==='3w')||(id==='3d'))}/>
                                    <label className="form-check-label inline-block ">
                                        All Administrators
                                    </label>
                            </div> 
                    ...
                    <tr>
                        <td className="border border-slate-300 text-left py-4">Transactions</td>
                        <td className="border border-slate-300 text-left py-4">
                            <div className="form-check">
                                <Checkbox id="9" value="transactions" name="Transactions" click={accessClick} isChecked={Array.isArray(checkedList)&&checkedList.some((id)=>(id==='9r')||(id==='9w')||(id==='9d'))}/>
                                <label className="form-check-label inline-block ">
                                    Transactions
                                </label>
                            </div>
                        ...
                        <td className="border border-slate-300 text-left py-4">
                            <div className="form-check flex space-x-5">
                                <div>
                                    <Checkbox id="9r" value="read" name="Transactions" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('9r')}/>
                                    <label className="form-check-label inline-block ">
                                        Read
                                    </label>
                                </div>
                                <div>
                                    <Checkbox id="9w" value="write" name="Transactions" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('9w')}/>
                                    <label className="form-check-label inline-block ">
                                        Write
                                    </label>
                                </div>
                                <div>
                                    <Checkbox id="9d" value="delete" name="Transactions" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('9d')}/>
                                    <label className="form-check-label inline-block ">
                                        Delete
                                    </label>
                                </div> 
                    ...
                    <tr>
                        <td className="border border-slate-300 text-left py-4">Customers</td>
                        <td className="border border-slate-300 text-left py-4">
                            <div className="form-check">
                                <Checkbox id="8" value="users/all" name="Users" click={accessClick} isChecked={Array.isArray(checkedList)&&checkedList.some((id)=>(id==='8r')||(id==='8w')||(id==='8d'))}/>
                                <label className="form-check-label inline-block ">
                                    All Customers 
                                </label>
                            </div>
                    ...
                    <tr>
                        ...
                        <td className="border border-slate-300 text-left py-4">
                          <div className="form-check">
                            ...
                            <div className="form-check">
                                <Checkbox id="13" value="merchant-settlement/all" name="Settlements History" click={accessClick} isChecked={Array.isArray(checkedList)&&checkedList.some((id)=>(id==='13r')||(id==='13w')||(id==='13d'))}/>                 
                                <label className="form-check-label inline-block ">
                                   Settlements History
                                </label>
                            </div>
                    ...
                    <tr>
                        <td className="border border-slate-300 text-left py-4">Direct Payout</td>
                        <td className="border border-slate-300 text-left py-4">
                            <div className="form-check">
                                <Checkbox id="21" value="payout/initiate" name="Payout Initiate" click={accessClick} isChecked={Array.isArray(checkedList)&&checkedList.some((id)=>(id==='21r')||(id==='21w')||(id==='21d'))}/>
                                <label className="form-check-label inline-block ">
                                    Initiate Payouts
                                </label>
                            </div>
                            <div className="form-check">
                                <Checkbox id="22" value="payout/approvals" name="Payout Approvals" click={accessClick} isChecked={Array.isArray(checkedList)&&checkedList.some((id)=>(id==='22r')||(id==='22w')||(id==='22d'))}/>
                                <label className="form-check-label inline-block ">
                                    Approve Payouts
                                </label>
                            </div>
                            <div className="form-check">
                                <Checkbox id="23" value="payout/all" name="Payout History" click={accessClick} isChecked={Array.isArray(checkedList)&&checkedList.some((id)=>(id==='23r')||(id==='23w')||(id==='23d'))}/>
                                <label className="form-check-label inline-block ">
                                    History
                                </label>
                            </div>
                        ...
                        <td className="border border-slate-300 text-left py-4">
                            <div className="form-check flex space-x-5">
                                <div>
                                    <Checkbox id="21r" value="read" name="Payout Initiate" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('21r')}/>
                                    <label className="form-check-label inline-block ">
                                        Read
                                    </label>
                                </div>
                                <div>
                                    <Checkbox id="21w" value="write" name="Payout Initiate" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('21w')}/>
                                    <label className="form-check-label inline-block ">
                                        Write
                                    </label>
                                </div>
                                <div>
                                    <Checkbox id="21d" value="delete" name="Payout Initiate" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('21d')}/>
                                    <label className="form-check-label inline-block ">
                                        Delete
                                    </label>
                                </div> 
                            ...
                            <div className="form-check flex space-x-5">
                                <div>
                                    <Checkbox id="22r" value="read" name="Payout Approvals" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('22r')}/>
                                    <label className="form-check-label inline-block ">
                                        Read
                                    </label>
                                </div>
                                <div>
                                    <Checkbox id="22w" value="write" name="Payout Approvals" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('22w')}/>
                                    <label className="form-check-label inline-block ">
                                        Write
                                    </label>
                                </div>
                                <div>
                                    <Checkbox id="22d" value="delete" name="Payout Approvals" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('22d')}/>
                                    <label className="form-check-label inline-block ">
                                        Delete
                                    </label>
                                </div> 
                            ...
                            <div className="form-check flex space-x-5">
                                <div>
                                    <Checkbox id="23r" value="read" name="Payout History" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('23r')}/>
                                    <label className="form-check-label inline-block ">
                                        Read
                                    </label>
                                </div>
                                <div>
                                    <Checkbox id="23w" value="write" name="Payout History" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('23w')}/>
                                    <label className="form-check-label inline-block ">
                                        Write
                                    </label>
                                </div>
                                <div>
                                    <Checkbox id="23d" value="delete" name="Payout History" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('23d')}/>
                                    <label className="form-check-label inline-block ">
                                        Delete
                                    </label>
                                </div> 
                    ...
                    <tr>
                        ...
                        <td className="border border-slate-300 text-left py-4">
                            <div className="form-check">
                                <Checkbox id="15" value="merchants/all/onboarding" name="Merchants Onboarding" click={accessClick} isChecked={Array.isArray(checkedList)&&checkedList.some((id)=>(id==='15r')||(id==='15w')||(id==='15d'))}/>
                                <label className="form-check-label inline-block ">
                                 Merchants Onboarding
                                </label>
                            </div>
                            <div className="form-check">
                                <Checkbox id="6" value="merchants/all/approved" name="Approved Merchants" click={accessClick} isChecked={Array.isArray(checkedList)&&checkedList.some((id)=>(id==='6r')||(id==='6w')||(id==='6d'))}/>
                                <label className="form-check-label inline-block ">
                                    Approved Merchants
                                </label>
                            </div>
                        ...
                        <td className="border border-slate-300 text-left py-4">
                            <div className="form-check flex space-x-5">
                                <div>
                                    <Checkbox id="15r" value="read" name="Merchants Onboarding" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('15r')}/>
                                    <label className="form-check-label inline-block ">
                                        Read
                                    </label>
                                </div>
                                <div>
                                    <Checkbox id="15w" value="write" name="Merchants Onboarding" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('15w')}/>
                                    <label className="form-check-label inline-block ">
                                        Write
                                    </label>
                                </div>
                                <div>
                                    <Checkbox id="15d" value="delete" name="Merchants Onboarding" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('15d')}/>
                                    <label className="form-check-label inline-block ">
                                        Delete
                                    </label>
                                </div> 
                            ...
                            <div className="form-check flex space-x-5">
                             <div>
                                <Checkbox id="6r" value="read" name="Approved Merchants" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('6r')}/>
                                <label className="form-check-label inline-block ">
                                    Read
                                </label>
                             </div>
                             <div>
                                <Checkbox id="6w" value="write" name="Approved Merchants" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('6w')} />
                                <label className="form-check-label inline-block ">
                                    Write
                                </label>
                             </div>
                    ...
                    <tr>
                        <td className="border border-slate-300 text-left py-4">Statiscal Reports</td>
                        <td className="border border-slate-300 text-left py-4">
                            <div className="form-check">
                                <Checkbox id="25" value="reports/customers" name="Customers Report" click={accessClick} isChecked={Array.isArray(checkedList)&&checkedList.some((id)=>(id==='25r'))}/>
                                <label className="form-check-label inline-block ">
                                    Customers Report
                                </label>
                            </div>
                            <div className="form-check">
                                <Checkbox id="26" value="reports/sales" name="Sales Report" click={accessClick} isChecked={Array.isArray(checkedList)&&checkedList.some((id)=>(id==='26r'))}/>
                                <label className="form-check-label inline-block ">
                                    Sales Report
                                </label>
                            </div>
                            <div className="form-check">
                                <Checkbox id="27" value="reports/transactions" name="Transactions Report" click={accessClick} isChecked={Array.isArray(checkedList)&&checkedList.some((id)=>(id==='27r'))}/>
                                <label className="form-check-label inline-block ">
                                    Transactions Report
                                </label>
                            </div>
                            <div className="form-check">
                                <Checkbox id="28" value="reports/fraud" name="Fraud Report" click={accessClick} isChecked={Array.isArray(checkedList)&&checkedList.some((id)=>(id==='28r'))}/>
                                <label className="form-check-label inline-block ">
                                    Fraud Report
                                </label>
                            </div>
                        ...
                        <td className="border border-slate-300 text-left py-4">
                            <div className="form-check flex space-x-5">
                                <div>
                                    <Checkbox id="25r" value="read" name="Customers Report" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('25r')}/>
                                    <label className="form-check-label inline-block ">
                                        Read
                                    </label>
                                </div>
                            ...
                            <div className="form-check flex space-x-5">
                                <div>
                                    <Checkbox id="26r" value="read" name="Sales Report" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('26r')}/>
                                    <label className="form-check-label inline-block ">
                                        Read
                                    </label>
                                </div>
                            ...
                            <div className="form-check flex space-x-5">
                                <div>
                                    <Checkbox id="27r" value="read" name="Transactions Report" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('27r')}/>
                                    <label className="form-check-label inline-block ">
                                        Read
                                    </label>
                                </div>
                            ...
                            <div className="form-check flex space-x-5">
                                <div>
                                    <Checkbox id="28r" value="read" name="Fraud Report" click={permissionClick} isChecked={Array.isArray(checkedList)&&checkedList.includes('28r')}/>
                                    <label className="form-check-label inline-block ">
                                        Read
                                    </label>
                                </div>
