          ...
          <tr>
            ...
            <td className="border border-slate-300 text-left py-4">
              ...
              <div className="form-check">
                <Checkbox
                  id="29"
                  value="merchants/add-documents"
                  name="Add Documents"
                  click={accessClick}
                  isChecked={
                    Array.isArray(checkedList) &&
                    checkedList.some(
                      (id) => id === "29r" || id === "29w" || id === "29d"
                    )
                  }
                />
                <label className="form-check-label inline-block ">
              ...
              <div className="form-check flex space-x-5">
                <div>
                  <Checkbox
                    ...
                    click={permissionClick}
                    isChecked={
                      Array.isArray(checkedList) && checkedList.includes("29r")
                    }
                  />
                  <label className="form-check-label inline-block ">Read</label>
                </div>
                <div>
                  <Checkbox
                    ...
                    click={permissionClick}
                    isChecked={
                      Array.isArray(checkedList) && checkedList.includes("29w")
                    }
                  />
                  <label className="form-check-label inline-block ">
                    Write
                ...
                <div>
                  <Checkbox
                    ...
                    click={permissionClick}
                    isChecked={
                      Array.isArray(checkedList) && checkedList.includes("29d")
                    }
                  />
                  <label className="form-check-label inline-block ">
                    Delete
