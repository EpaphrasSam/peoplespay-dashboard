...
const PaidHighLights = ({transactions}:{transactions:AppProps}) => {
  ...
  return (
    <>
      <div className="font-segoe relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded">
        <div className="rounded-t mb-0 px-4 py-3 border-0">
          <div className="flex flex-wrap items-center">
            <div className="relative w-full px-4 max-w-full flex-grow flex-1">
              <h3 className="font-poppins font-extrabold text-base text-left">
                Successful transactions <span className='text-indigo-800 px-2  leading-8 text-xs'>showing latest highlights...</span>
              </h3>
            </div>
