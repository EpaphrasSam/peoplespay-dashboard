...
const VerifyOtp: React.FC = () => {
    ...
    const onSubmit = async(e:any)=>{
        ...
        try{
            setLoading(true);
            const res = await authService.validateOtp({ idn: location.state.email, otp: code });
            setLoading(false);
            await Swal.fire({
                position: 'top-end',
  ...
  return (
    <>
        ...
        <h6 className="text-black mt-6 font-inter">Check your email and enter OTP code</h6>
