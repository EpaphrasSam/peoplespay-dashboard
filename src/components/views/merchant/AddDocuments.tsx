    ...
    <div className="relative flex flex-col shadow-md items-center md:pt-10 pb-10  w-full">
        ...
        <div className="flex flex-col items-center px-4 w-full lg:px-10 py-10 pt-0">
            <div className="relative w-6/12 mb-3">
                <label className="block uppercase text-gray-700 text-xs font-semibold mb-2 text-left" htmlFor="grid-password">
                    select merchant
                </label>
                <select className="border-0 px-3 py-3 placeholder-blueGray-300  bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                    name="merchantId"
            ...
            <div className="relative w-6/12 mb-3">
                ...
                <input type="text" className="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                    ...
                    onChange = {(e) => setFormData({ ...formData, docxName: e.target.value })}
                />
            </div>
            <div className="relative w-6/12 mb-3">
                <label className="block uppercase text-gray-700 text-xs font-semibold mb-2 text-left" htmlFor="grid-password">
                ...
                <input type="file" id='fileupload' className="hidden border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                    name="documentName"
                    onChange = {(e) => onFileChange(e)}
                />
                <label className={fileName?"block uppercase text-gray-700 shadow p-2 text-xs font-semibold mb-2 text-left": "block p-2 bg-gray-300 text-gray-700"} htmlFor="fileupload">
                    {fileName ? fileName : 'Select File'}
                </label>
            </div>
        </div>
        <button onClick={add} className='w-8/12 mx-auto uppercase font-bold text-sm float-right mb-4 bg-red-700 leading-tight text-white py-3 px-6 rounded hover:bg-red-900 hover:ring-2 hover:ring-red-800'>
