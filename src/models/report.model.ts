...
export class ReportModel {
  ...
  constructor(report: any) {
    ...
    this.customerName =
      ...
      report.customerId?.merchant_tradeName ||
      report.payment_account_name;
    ...
    this.paymentIssuer = report.payment_account_issuer
      ? report.payment_account_issuer || report.payment_account_issuer_name
      : "WALLET";
