...
const MerchantCategories = lazy(
  () => import("./components/views/merchant/MerchantCategory")
);
const MerchantTransactions = lazy(
  () => import("./components/views/merchant/MerchantTransactions")
);
...
const FailedTransactions = lazy(
  () => import("./components/views/failed/FailedTransactions")
);
const Charges = lazy(() => import("./components/views/charges/Charges"));
const BroadCastMessage = lazy(
  () => import("./components/views/broadcast/Broadcast")
);
const Settlement = lazy(
  () => import("./components/views/settlement/Settlement")
);
const AllSettlements = lazy(
  () => import("./components/views/settlement/AllSettlements")
);
const SettlementApprovals = lazy(
  () => import("./components/views/settlement/Approvals")
);
const ElevyTransactions = lazy(
  () => import("./components/views/elevy/Transactions")
);
const ElevyTransactionsDetails = lazy(
  () => import("./components/views/elevy/TransactionDetails")
);
const WalletTrasactions = lazy(
  () => import("./components/views/wallet/WalletTransactions")
);
...
const ChangePasswordForm = lazy(
  () => import("./components/views/changepassword/ChangePasswordForm")
);
...
const DirectDebit = lazy(
  () => import("./components/views/directdebit/DirectDebit")
);
const DirectCredit = lazy(
  () => import("./components/views/directdebit/DirectCredit")
);
const PendingReversals = lazy(
  () => import("./components/views/reversals/Approvals")
);
const InitiateDirectPayout = lazy(
  () => import("./components/views/directpayout/InitiatePayoutPage")
);
const PayoutApprovals = lazy(
  () => import("./components/views/directpayout/PayoutApprovals")
);
            ...
            <AnimatePresence exitBeforeEnter>
              <Routes>
                ...
                >
                  ...
                  {/**Merchant Config*/}
                  <Route path="configurations"></Route>
                  ...
                  {/**paid transactions */}
                  <Route
                    path="allpaid-transactions"
                    element={<PaidTransactions />}
                  />

                  {/**paid / successf transactions */}
                  <Route
                    path="allfailed-transactions"
